...
var format_Gis3_1 = new ol.format.GeoJSON();
var features_Gis3_1 = format_Gis3_1.readFeatures(json_Gis3_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Gis3_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Gis3_1.addFeatures(features_Gis3_1);
var lyr_Gis3_1 = new ol.layer.Heatmap({
                declutter: true,
                source:jsonSource_Gis3_1, 
                radius: 5 * 2,
...
lyr_OSMStandard_0.setVisible(true);lyr_Gis3_1.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_Gis3_1];
